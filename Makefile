...
SRCS     += $(wildcard src/STM32F401XE/*.s)
SRCS	 += $(wildcard src/SPL_src/*c)
SRCS  	 += $(wildcard src/*.c)

INCDIRS   = src/STM32F401XE src/SPL_inc src

LSCRIPT   = src/STM32F401XE/STM32F401VC_FLASH.ld
